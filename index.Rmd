...
**Lo que su sede es que  listaPrueba[[3]]$c[[2]] es igual a la listaPrueba$casos[[3]][[2]], en el primer ejemplo ingresamos al dato 3 de la lista principal y de ahí a la sublista, y luego al dato 2, lo que queda como resultado es el valor booleano.**

4.- ?Cuál es la diferencia entre `listaPrueba[1]` y `listaPrueba[[1]]`?
**imprime en pantalla el nombre de la casilla  y los datos dentro de ella**
